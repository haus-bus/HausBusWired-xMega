...
public:
  ...
  public:
    ...
    union Parameter
    {
      ...
      HwConfiguration::HomeAutomation setConfiguration;
  ...
  public:
    ...
    {
      HwConfiguration::HomeAutomation hwConfiguration;
    ...
    inline HwConfiguration::HomeAutomation& setConfiguration( uint8_t fcke );
...
inline HwConfiguration::HomeAutomation& HomeAutomationInterface::Response::setConfiguration(
    uint8_t fcke )
{
