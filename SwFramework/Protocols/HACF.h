/*********************************************************************
 ...
 File Path	: AR8/release/SwFramework/Protocols/HomeAutomationControlFrame/HACF.h
 *********************************************************************/
...
public:
  ...
  public:
    ...
    uint8_t instanceId;		//## attribute instanceId

    uint8_t classId;		//## attribute classId

    uint8_t address;		//## attribute address

    uint8_t networkId;		//## attribute networkId
  };
  ...
  public:
    ...
    uint8_t control;		//## attribute control

    uint8_t packetCounter;		//## attribute packetCounter

    Object senderId;		//## attribute senderId

    Object receiverId;		//## attribute receiverId

    uint16_t dataLength;		//## attribute dataLength

    uint8_t data[DEFAULT_DATA_LENGTH];		//## attribute data
  };
...
public:
  ...
  static uint16_t deviceId;		//## attribute deviceId

  static uint16_t receiverIdForErrors;		//## attribute receiverIdForErrors

  static uint16_t messagesInUse;    //## attribute messagesInUse

  Header header;		//## attribute header

  ControlFrame controlFrame;		//## attribute controlFrame
