...
HBWLC4IN4DRHw::HBWLC4IN4DRHw() :
   ...
   lightControl1( PortPin( PortC, 0 ), &config.ledCfg[0], false, DEFAULT_PWM_RANGE ),
   lightControl2( PortPin( PortC, 1 ), &config.ledCfg[1], false, DEFAULT_PWM_RANGE ),
   lightControl3( PortPin( PortC, 2 ), &config.ledCfg[2], false, DEFAULT_PWM_RANGE ),
   lightControl4( PortPin( PortC, 3 ), &config.ledCfg[3], false, DEFAULT_PWM_RANGE ),
