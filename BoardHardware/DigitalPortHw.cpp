...
void DigitalPortHw::on(uint8_t pin, uint8_t value) {
    ...
    {
      if     ( pin == Pin0 ) timerCounter0->setCompareA( value );
      else if( pin == Pin1 ) timerCounter0->setCompareB( value );   
      else if( pin == Pin2 ) timerCounter0->setCompareC( value );
      else if( pin == Pin3 ) timerCounter0->setCompareD( value ); 
    }   
    else if( (pin < Pin6) && timerCounter1 )
    {
      if     ( pin == Pin4 ) timerCounter1->setCompareA( value );
      else if( pin == Pin5 ) timerCounter1->setCompareB( value );
    }
    else
    {
      if( value )         
