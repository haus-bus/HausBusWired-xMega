...
void board_init(void)
{
	...
	ioport_configure_pin(STATUS_LED_GREEN_GPIO, IOPORT_MODE_INVERT_PIN | IOPORT_DIR_OUTPUT | IOPORT_INIT_HIGH);
	ioport_configure_pin(STATUS_LED_RED_GPIO,   IOPORT_MODE_INVERT_PIN | IOPORT_DIR_OUTPUT | IOPORT_INIT_HIGH);
	
	ioport_configure_pin(LED1_GPIO, IOPORT_MODE_INVERT_PIN | IOPORT_DIR_OUTPUT | IOPORT_INIT_LOW);
	ioport_configure_pin(LED2_GPIO, IOPORT_MODE_INVERT_PIN | IOPORT_DIR_OUTPUT | IOPORT_INIT_LOW);
	ioport_configure_pin(LED3_GPIO, IOPORT_MODE_INVERT_PIN | IOPORT_DIR_OUTPUT | IOPORT_INIT_LOW);
	ioport_configure_pin(LED4_GPIO, IOPORT_MODE_INVERT_PIN | IOPORT_DIR_OUTPUT | IOPORT_INIT_LOW);
	ioport_configure_pin(LED5_GPIO, IOPORT_MODE_INVERT_PIN | IOPORT_DIR_OUTPUT | IOPORT_INIT_LOW);
	ioport_configure_pin(LED6_GPIO, IOPORT_MODE_INVERT_PIN | IOPORT_DIR_OUTPUT | IOPORT_INIT_LOW);
