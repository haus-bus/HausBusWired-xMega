...
{
	ioport_configure_pin(STATUS_LED_GREEN_GPIO, IOPORT_DIR_OUTPUT | IOPORT_INIT_HIGH);
	ioport_configure_pin(STATUS_LED_RED_GPIO,   IOPORT_DIR_OUTPUT | IOPORT_INIT_HIGH);
